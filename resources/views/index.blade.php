...
@section('description')
    This is the homepage of Gaurav Garry Website.
@endsection
...
@section('content')
                        ...
                        <li data-index="rs-1" data-transition="random" data-slotamount="default" data-hideafterloop="0"
                            ...
                            <div class="tp-caption tp-resizeme rs-parallaxlevel-2" id="slide1-layer-2"
                                ...
                                style="letter-spacing: 0;font-weight:700;font-family: Barlow;color:#fff;"><img
                                    src="assets/images/slide1-shape2.png" alt="slide1-shape2.png">
                            </div>
                            ...
                            <div class="tp-caption rev-btn thm-btn header-btn" id="slide1-layer-7"
                                ...
                                data-paddingright="[40,40,35,30]" data-paddingbottom="[20.1,17,14,12]"
                                data-paddingleft="[40,40,35,30]"
                                style="cursor:pointer;line-height: 1.5625rem;display: inline-block;font-family: Montserrat;letter-spacing: 0;font-weight: 600;color: #fff;border-radius: 3px;">
                                Dive-In
                            </div>
                        </li>
                    </ul>
                ...
                <div class="serv-wrap w-100 text-center">
                    <div class="row">
                        <div class="col-md-4 col-sm-6 col-lg-4">
                            <div class="srv-box1 mb-30 w-100 brd-rd10">
                                <img class="img-fluid" src="assets/images/resources/serv-icon1.png" alt="Service Icon 1">
                                <div class="srv-info1 mt-30 w-100">
                                    <h3 class="mb-0">ui / ux design</h3>
                                    <p class="mb-0 mt-20">Place lights there don't grass, may dry from. Us he, itself may
                                        saw beginning. Night upon, they're created.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4 col-sm-6 col-lg-4">
                            <div class="srv-box1 mb-30 w-100 brd-rd10">
                                <img class="img-fluid" src="assets/images/resources/serv-icon2.png" alt="Service Icon 2">
                                <div class="srv-info1 mt-30 w-100">
                                    <h3 class="mb-0">Outreach Visitors</h3>
                                    <p class="mb-0 mt-20">Place lights there don't grass, may dry from. Us he, itself may
                                        saw beginning. Night upon, they're created.</p>
                                </div>
                            </div>
                        ...
                        <div class="col-md-4 col-sm-6 col-lg-4">
                            <div class="srv-box1 mb-30 w-100 brd-rd10">
                                <img class="img-fluid" src="assets/images/resources/serv-icon3.png" alt="Service Icon 3">
                                <div class="srv-info1 mt-30 w-100">
                                    <h3 class="mb-0">Digital Branding</h3>
                                    <p class="mb-0 mt-20">Place lights there don't grass, may dry from. Us he, itself may
                                        saw beginning. Night upon, they're created.</p>
                                </div>
                            </div>
    ...
    <section>
        <div class="w-100 pb-70 position-relative">
            <div id="particles1" class="particles-js top-left" data-saturation="300" data-size="40" data-count="20"
                data-speed="2" data-hide="770" data-image="assets"></div>
            <div class="container">
                <div class="about-wrap w-100">
                    <div class="row align-items-center">
                        <div class="col-md-12 col-sm-12 col-lg-7">
                            <div class="about-mckp slide-animation w-100">
                                <img class="img-fluid" src="assets/images/resources/about-mckp1.jpg"
                                    alt="About Mockup 1">
                            </div>
                        </div>
                        <div class="col-md-12 col-sm-12 col-lg-5">
                            <div class="about-info w-100">
                                <h2 class="mb-0">Offering Bespoke Solutions</h2>
                ...
                <div class="row mrg">
                    <div class="col-md-12 col-sm-12 col-lg-6">
                        <div class="port-box1 bg-black position-relative overflow-hidden w-100">
                            <img class="img-fluid w-100" src="assets/images/resources/port-img1-1.jpg"
                                alt="Portfolio Image 1">
                            <div class="port-info1 position-absolute w-100">
                                <span class="text-color2">Adobe illustrator</span>
                                <h3 class="mb-0"><a href="portfolio-detail.html" title="">Geomerty Kings</a></h3>
                            </div>
                            <div class="port-bottom-info1 position-absolute w-100">
                                <i class="bg-black position-absolute"></i>
                                <span class="text-color2">Adobe illustrator</span>
                                <h3 class="mb-0">Geomerty Kings</h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-12 col-sm-12 col-lg-6">
                        <div class="row mrg">
                            <div class="col-md-12 col-sm-12 col-lg-12">
                                <div class="port-box1 bg-color8 position-relative overflow-hidden w-100">
                                    <img class="img-fluid w-100" src="assets/images/resources/port-img1-2.jpg"
                                        alt="Portfolio Image 2">
                                    <div class="port-info1 position-absolute w-100">
                                        <span class="text-color3">Branindo</span>
                                        <h3 class="mb-0"><a href="portfolio-detail.html" title="">Beyondot</a>
                                        </h3>
                                    </div>
                                    <div class="port-bottom-info1 position-absolute w-100">
                                        <i class="bg-color8 position-absolute"></i>
                                        <span class="text-color3">Branindo</span>
                                        <h3 class="mb-0">Beyondot</h3>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 col-sm-6 col-lg-6">
                                <div class="port-box1 bg-color9 position-relative overflow-hidden w-100">
                                    <img class="img-fluid w-100" src="assets/images/resources/port-img1-3.jpg"
                                        alt="Portfolio Image 3">
                                    <div class="port-info1 position-absolute w-100">
                                        <span class="text-color4">Branindo</span>
                                        <h3 class="mb-0"><a href="portfolio-detail.html" title="">Bio
                                                Conlomto</a></h3>
                                    </div>
                                    <div class="port-bottom-info1 position-absolute w-100">
                                        <i class="bg-color9 position-absolute"></i>
                                        <span class="text-color4">Branindo</span>
                                        <h3 class="mb-0">Bio Conlomto</h3>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 col-sm-6 col-lg-6">
                                <div class="port-box1 bg-color10 position-relative overflow-hidden w-100">
                                    <img class="img-fluid w-100" src="assets/images/resources/port-img1-4.jpg"
                                        alt="Portfolio Image 4">
                                    <div class="port-info1 position-absolute w-100">
                                        <span class="text-color5">Branindo</span>
                                        <h3 class="mb-0"><a href="portfolio-detail.html" title="">Bio
                                                Conlomto</a></h3>
                                    </div>
                                    <div class="port-bottom-info1 position-absolute w-100">
                    ...
                    <div class="col-md-6 col-sm-6 col-lg-3">
                        <div class="port-box1 bg-color11 position-relative overflow-hidden w-100">
                            <img class="img-fluid w-100" src="assets/images/resources/port-img1-5.jpg"
                                alt="Portfolio Image 5">
                            <div class="port-info1 position-absolute w-100">
                                <span class="text-color2">Branindo</span>
                                <h3 class="mb-0"><a href="portfolio-detail.html" title="">Bio Conlomto</a></h3>
                            </div>
                            <div class="port-bottom-info1 position-absolute w-100">
                                <i class="bg-color11 position-absolute"></i>
                                <span class="text-color2">Branindo</span>
                                <h3 class="mb-0">Bio Conlomto</h3>
                            </div>
                        </div>
                    ...
                    <div class="col-md-6 col-sm-6 col-lg-3">
                        <div class="port-box1 bg-color12 position-relative overflow-hidden w-100">
                            <img class="img-fluid w-100" src="assets/images/resources/port-img1-6.jpg"
                                alt="Portfolio Image 6">
                            <div class="port-info1 position-absolute w-100">
                                <span class="text-color6">Branindo</span>
                                <h3 class="mb-0"><a href="portfolio-detail.html" title="">Bio Conlomto</a></h3>
                            </div>
                            <div class="port-bottom-info1 position-absolute w-100">
                                <i class="bg-color12 position-absolute"></i>
                                <span class="text-color6">Branindo</span>
                                <h3 class="mb-0">Bio Conlomto</h3>
                            </div>
                        </div>
                    ...
                    <div class="col-md-12 col-sm-12 col-lg-6">
                        <div class="port-box1 bg-color13 position-relative overflow-hidden w-100">
                            <img class="img-fluid w-100" src="assets/images/resources/port-img1-7.jpg"
                                alt="Portfolio Image 7">
                            <div class="port-info1 position-absolute w-100">
                                <span class="text-color7">Branindo</span>
                                <h3 class="mb-0"><a href="portfolio-detail.html" title="">Beyondot</a></h3>
                            </div>
                            <div class="port-bottom-info1 position-absolute w-100">
                                <i class="bg-color13 position-absolute"></i>
                                <span class="text-color7">Branindo</span>
                                <h3 class="mb-0">Beyondot</h3>
                            </div>
                        </div>
            ...
            <div class="container">
                <div class="video-pres-wrap text-center w-100">
                    <div class="video-pres-inner d-inline-block">
                        <a href="https://www.youtube.com/watch?v=ANwf8AE3_d0" data-fancybox title="Video"><i
    ...
    <section>
        <div class="w-100 pt-130 pb-130 position-relative">
            <div id="particles2" class="particles-js top-left" data-saturation="300" data-size="40" data-count="20"
                data-speed="2" data-hide="770" data-image="assets"></div>
            <div class="container">
                <div class="team-wrap position-relative w-100">
                    <div class="team-caro">
                        <div>
                            <div class="team-item d-flex align-items-center w-100">
                                <img class="img-fluid rounded-circle d-inline-block"
                                    src="assets/images/resources/team-img1-1.jpg" alt="Team Image 1">
                                <div class="team-info">
                                    <h3 class="mb-0">Talhah Doyle</h3>
                                    <span class="d-block">Community Manager</span>
                                    <p class="mb-0">Lorem ipsum dolor sit amet consectetur adipiscing elit sed doeiusmod
                                        tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam quis
                                        nostrud.</p>
                                    <div class="scl d-inline-block">
                                        <a href="javascript:void(0);" title="Facebook" target="_blank"><img
                                                class="img-fluid" src="assets/images/fb-icon.png" alt="Facebook"></a>
                                        <a href="javascript:void(0);" title="Twitter" target="_blank"><img
                                                class="img-fluid" src="assets/images/tw-icon.png" alt="Twitter"></a>
                                        <a href="javascript:void(0);" title="Google" target="_blank"><img
                                                class="img-fluid" src="assets/images/gl-icon.png" alt="Google"></a>
                                        <a href="javascript:void(0);" title="Youtube" target="_blank"><img
                                                class="img-fluid" src="assets/images/yt-icon.png" alt="Youtube"></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div>
                            <div class="team-item d-flex align-items-center w-100">
                                <img class="img-fluid rounded-circle d-inline-block"
                                    src="assets/images/resources/team-img1-2.jpg" alt="Team Image 2">
                                <div class="team-info">
                                    <h3 class="mb-0">Jay Hunter</h3>
                                    <span class="d-block">Manager, WordPress Co.</span>
                                    <p class="mb-0">Lorem ipsum dolor sit amet consectetur adipiscing elit sed doeiusmod
                                        tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam quis
                                        nostrud.</p>
                                    <div class="scl d-inline-block">
                    ...
                    <div class="team-nav-caro">
                        <img class="img-fluid rounded-circle" src="assets/images/resources/team-nav-img1-1.jpg"
                            alt="Team Nav Image 1">
                        <img class="img-fluid rounded-circle" src="assets/images/resources/team-nav-img1-2.jpg"
                            alt="Team Nav Image 2">
                    </div>
                </div><!-- Team Style 1 -->
            </div>
        </div>
    ...
    <section>
        <div class="w-100 py-130 gray-layer2 opc8 position-relative">
            <div class="fixed-bg bg-color14" style="background-image: url(assets/images/pattern-bg1.jpg);"></div>
            <div class="container">
                <div class="pric-tabs">
                    <div class="row align-items-center">
                        <div class="col-md-4 col-sm-12 col-lg-4">
                            <ul class="nav nav-tabs">
                                <li class="nav-item"><a class="nav-link active" data-toggle="tab"
                                        href="#price-tab1">adobe illustrator.</a></li>
                                <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#price-tab2">photoshop
                                        website.</a></li>
                                <li class="nav-item"><a class="nav-link" data-toggle="tab"
                                        href="#price-tab3">wordpress.</a></li>
                                <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#price-tab4">article
                                        rewriter.</a></li>
                                <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#price-tab5">Adobe
                                        XD.</a></li>
                            </ul>
                        </div>
                        <div class="col-md-8 col-sm-12 col-lg-8">
                            <div class="tab-content">
                                <div class="tab-pane fade show active" id="price-tab1">
                                    <div class="row mrg">
                                        <div class="col-md-8 col-sm-6 col-lg-8">
                                            <div class="price-post position-relative w-100">
                                                <img class="img-fluid w-100"
                                                    src="assets/images/resources/price-post-img1.jpg"
                                                    class="Price Post Image 1">
                                                <div class="price-post-info position-absolute">
                                                    <h3 class="mb-0">Animation Price</h3>
                                                    <span class="d-block">design & branding agency</span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-4 col-sm-6 col-lg-4">
                                            <div class="price-table w-100 text-center"
                                                style="background-image: url(assets/images/price-post-bg.png);">
                                                <div class="price-head w-100">
                                                    <h3 class="mb-0">Standard</h3>
                                                    <span>Monthly plan</span>
                                                    <i class="price">$20</i>
                                                </div>
                                                <div class="price-body w-100">
                                                    <ul class="mb-0 list-unstyled w-100">
                                                        <li><u>20GB</u> Storage Space</li>
                                                        <li><u>70GB</u> Bandwidth</li>
                                                        <li>20 Free Sub-Domains</li>
                                                        <li>150 E-mail Accounts</li>
                                                        <li>Control Panel & FTP</li>
                                                    </ul>
                                                </div>
                                                <a class="thm-btn mini-btn brd-rd3" href="javascript:void(0);"
                                                    title="">BUY NOW</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="tab-pane fade" id="price-tab2">
                                    <div class="row mrg">
                                        <div class="col-md-8 col-sm-6 col-lg-8">
                                            <div class="price-post position-relative w-100">
                                                <img class="img-fluid w-100"
                                                    src="assets/images/resources/price-post-img2.jpg"
                                                    class="Price Post Image 2">
                                                <div class="price-post-info position-absolute">
                                                    <h3 class="mb-0">Animation Price</h3>
                                                    <span class="d-block">design & branding agency</span>
                                                </div>
                                ...
                                <div class="tab-pane fade" id="price-tab3">
                                    <div class="row mrg">
                                        <div class="col-md-8 col-sm-6 col-lg-8">
                                            <div class="price-post position-relative w-100">
                                                <img class="img-fluid w-100"
                                                    src="assets/images/resources/price-post-img3.jpg"
                                                    class="Price Post Image 3">
                                                <div class="price-post-info position-absolute">
                                                    <h3 class="mb-0">Animation Price</h3>
                                                    <span class="d-block">design & branding agency</span>
                                                </div>
                                ...
                                <div class="tab-pane fade" id="price-tab4">
                                    <div class="row mrg">
                                        <div class="col-md-8 col-sm-6 col-lg-8">
                                            <div class="price-post position-relative w-100">
                                                <img class="img-fluid w-100"
                                                    src="assets/images/resources/price-post-img4.jpg"
                                                    class="Price Post Image 4">
                                                <div class="price-post-info position-absolute">
                                                    <h3 class="mb-0">Animation Price</h3>
                                                    <span class="d-block">design & branding agency</span>
                                                </div>
                                ...
                                <div class="tab-pane fade" id="price-tab5">
                                    <div class="row mrg">
                                        <div class="col-md-8 col-sm-6 col-lg-8">
                                            <div class="price-post position-relative w-100">
                                                <img class="img-fluid w-100"
                                                    src="assets/images/resources/price-post-img5.jpg"
                                                    class="Price Post Image 5">
                                                <div class="price-post-info position-absolute">
                                                    <h3 class="mb-0">Animation Price</h3>
                                                    <span class="d-block">design & branding agency</span>
                                                </div>
                    ...
                    <ul class="facts-list d-flex flex-wrap mb-0 list-unstyled w-100">
                        <li>
                            <div class="fact-box mt-30 w-100">
                                ...
                                <h2 class="mb-0"><span class="counter">1982</span></h2>
                        ...
                        <li>
                            <div class="fact-box mt-30 w-100">
                                ...
                                <h2 class="mb-0"><span class="counter">44</span>+</h2>
                        ...
                        <li>
                            <div class="fact-box mt-30 w-100">
                                ...
                                <h2 class="mb-0"><span class="counter">21</span>k</h2>
                        ...
                        <li>
                            <div class="fact-box mt-30 w-100">
                                ...
                                <h2 class="mb-0"><span class="counter">121</span></h2>
            ...
            <div class="container">
                ...
                <div class="blog-wrap position-relative w-100">
                    <div class="post-style1 rev mb-30 overflow-hidden d-flex flex-wrap brd-rd10 bg-color15">
                        <div class="post-img1"><a href="blog-detail.html" title=""><img class="img-fluid"
                                    src="assets/images/resources/post-img1-1.png" alt="Post Image 1"></a></div>
                        <div class="post-info1 bg-color17">
                            <span class="post-cat d-block"><a class="bg-color18" href="javascript:void(0);"
                                    title="">Branding</a></span>
                            <h3 class="mb-0"><a href="blog-detail.html" title="">get some weight off feet.</a>
                            </h3>
                            ...
                            <a class="thm-btn mini-btn brd-rd3" href="blog-detail.html" title="">Read More</a>
                        </div>
                    </div>
                    <div class="post-style1 mb-30 overflow-hidden d-flex flex-wrap brd-rd10 bg-color19">
                        <div class="post-img1"><a href="blog-detail.html" title=""><img class="img-fluid"
                                    src="assets/images/resources/post-img1-2.png" alt="Post Image 2"></a></div>
                        <div class="post-info1 bg-color20">
                            <span class="post-cat d-block"><a class="bg-color19" href="javascript:void(0);"
                                    title="">Branding</a></span>
                            <h3 class="mb-0"><a href="blog-detail.html" title="">get some weight off feet.</a>
                            </h3>
                            <p class="mb-0">Lorem ipsum dolor sit amet consectetur adipiscing elit sed doeiusmod tempor
    ...
    <section>
        <div class="w-100 pt-120 pb-120">
            <div class="fixed-bg back-post-lftcntr bg-norepeate gray-bg"
                style="background-image: url(assets/images/parallax2.jpg);"></div>
            <div class="container">
                        ...
                        <div class="col-md-7 col-sm-12 col-lg-5">
                            <div class="feat-info-wrap w-100">
                                ...
                                <div class="feat-box mt-35 d-flex flex-wrap align-items-center w-100">
                                    <img class="img-fluid" src="assets/images/resources/feat-icon1.png"
                                        alt="Featured Icon 1">
                                    <div class="feat-info">
                                        <h3 class="mb-0">Responsive Design</h3>
                                        <p class="mb-0">Investigationes demonstraverunt lectores legere me lius quod.</p>
                                    </div>
                                </div>
                                <div class="feat-box mt-35 d-flex flex-wrap align-items-center w-100">
                                    <img class="img-fluid" src="assets/images/resources/feat-icon2.png"
                                        alt="Featured Icon 2">
                                    <div class="feat-info">
                                ...
                                <div class="feat-box mt-35 d-flex flex-wrap align-items-center w-100">
                                    <img class="img-fluid" src="assets/images/resources/feat-icon3.png"
                                        alt="Featured Icon 3">
                                    <div class="feat-info">
                        ...
                        <div class="col-md-3 col-sm-3 col-lg-3">
                            <div class="sponsor-item mt-30 w-100">
                                <a href="javascript:void(0);" title=""><img class="img-fluid"
                                        src="assets/images/resources/sponsor1.png" alt="Sponsor 1"></a>
                            </div>
                        </div>
                        <div class="col-md-3 col-sm-3 col-lg-3">
                            <div class="sponsor-item mt-30 w-100">
                                <a href="javascript:void(0);" title=""><img class="img-fluid"
                                        src="assets/images/resources/sponsor2.png" alt="Sponsor 2"></a>
                            </div>
                        </div>
                        <div class="col-md-3 col-sm-3 col-lg-3">
                            <div class="sponsor-item mt-30 w-100">
                                <a href="javascript:void(0);" title=""><img class="img-fluid"
                                        src="assets/images/resources/sponsor3.png" alt="Sponsor 3"></a>
                            </div>
                        </div>
                        <div class="col-md-3 col-sm-3 col-lg-3">
                            <div class="sponsor-item mt-30 w-100">
                                <a href="javascript:void(0);" title=""><img class="img-fluid"
                                        src="assets/images/resources/sponsor4.png" alt="Sponsor 4"></a>
                            </div>
                        </div>
                    </div>
                </div><!-- Sponsor Style 1 -->
                        ...
                        <div class="col-md-9 col-sm-12 col-lg-8">
                            <div class="newsletter w-100 text-center">
                                <div class="newsletter-inner d-inline-block">
                                    ...
                                    <form class="rounded-pill overflow-hidden position-relative w-100 d-inline-block">
