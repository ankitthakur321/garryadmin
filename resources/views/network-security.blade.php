        ...
        <div class="w-100 position-relative">
            ...
            <div class="container">
                <div class="page-title text-center w-100">
                    ...
                    <p class="mb-0 text-white">Lorem ipsum dolor sit amet consectetur adipisicing elit. Distinctio maxime,
                        consequuntur velit repellat quas dolorum voluptatem! Ab et velit vitae, pariatur temporibus quae
                        aliquam distinctio ipsum, quasi odio, odit modi.</p>
                </div><!-- Page Title -->
                <ol class="breadcrumb">
